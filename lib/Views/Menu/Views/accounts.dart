...
class _AccountsViewState extends State<AccountsView> {
  ...
  Widget _buildAccounts(Accounts account) {
    ...
    switch(account.accCategoryId){
      case 1: backgroundColor = Colors.lime;
      case 2: backgroundColor = Colors.deepOrangeAccent;
      case 3: backgroundColor = Colors.cyan;
      case 4: backgroundColor = Colors.blue;
      case 5: backgroundColor = Colors.lightGreen;
      case 6: backgroundColor = Colors.purple;
      case 7: backgroundColor = Colors.yellow;
      case 8: backgroundColor = Colors.lightBlueAccent;
    }
    return Padding(
      padding: const EdgeInsets.all(8.0),
      child: Row(
          ...
          Row(
            children: [
              CircleAvatar(
                ...
                child: Text(account.accountName!.getFirstLetter,style: TextStyle(color: Colors.white,fontSize: 20)),
              ),
              ...
              Column(
                ...
                children: [
                  Text(account.accountName!,style: textTheme.titleMedium,),
                  Row(
                    children: [
                      Container(
                          ...
                          child: Text(account.accCategoryName!,style: textTheme.bodySmall)),
                      ...
                      Container(
                          ...
                          child: Text(account.accountNumber!,style: textTheme.bodySmall)),
